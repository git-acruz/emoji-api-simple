...
const app = express();
// const PORT = 5000; api deployed online
...
// Route to get emojis by category
app.get("/emoji/category/:category", (req, res) => {
    const categoryParam = req.params.category.toLowerCase();
    const filteredEmojis = emojis.filter(emoji => emoji.category.toLowerCase() === categoryParam);
